...
function baseStyles() {
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  table{width:100%;border-collapse:collapse;font-size:.875rem}th,td{padding:12px 10px;text-align:left;border-bottom:1px solid var(--border)}th{color:var(--muted);font-we
